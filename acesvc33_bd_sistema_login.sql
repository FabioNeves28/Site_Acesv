CREATE DATABASE  IF NOT EXISTS `acesvc33_bd_sistema_login` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `acesvc33_bd_sistema_login`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: acesvc33_bd_sistema_login
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'acesvc33_bd_sistema_login'
--
