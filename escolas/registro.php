...
#checkboxes label:hover {
  background-color: #1e90ff;
    ...
    <div id="checkboxes">
      <label for="one">
        <input type="checkbox" id="one" name="alicerce"/>Alicerce</label></input>
      <label for="two">
        <input type="checkbox" id="two" name="reis"/>Antônio Fernandes de Reis</label></input>
      <label for="three">
        <input type="checkbox" id="three" />APAE</label>
    </div>
  </div>
        <br><br>
