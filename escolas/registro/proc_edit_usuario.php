...
$result_usuario = "UPDATE dados SET email='$email', cpf='$cpf', data_nascimento='$data_nascimento',telefone='$telefone',bairros='$bairros',veiculo='$veiculo',capacidade='$capacidade',placa='$placa',ano='$ano',validade='$validade'
,endereco='$endereco',bairro='$bairro',cep='$cep',numero='$numero',complemento='$complemento', modified=NOW() WHERE id='$id'";
$resultado_usuario = mysqli_query($conn, $result_usuario);
$query_dados = "SELECT nome FROM dados";
